...
PROJECT_AGENTS_DIR = ".ecomdevagent/agents"
USER_AGENTS_DIR = "~/.ecomdevagent/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("ecomdevagent.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from ecomdevagent.agents.parser import parse_frontmatter, _validate_agent_meta

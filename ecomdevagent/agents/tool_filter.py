...
def build_teammate_tools(
    ...
    from ecomdevagent.tools.send_message import SendMessageTool
    from ecomdevagent.tools.task_create import TaskCreateTool
    from ecomdevagent.tools.task_get import TaskGetTool
    from ecomdevagent.tools.task_list import TaskListTool
    from ecomdevagent.tools.task_update import TaskUpdateTool

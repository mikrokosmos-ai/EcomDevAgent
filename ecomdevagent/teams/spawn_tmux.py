...
def build_cli_command(
    ...
    env_parts = [
        f"ECOMDEVAGENT_TEAM_NAME={team_name}",
        f"ECOMDEVAGENT_TEAMMATE_NAME={teammate_name}",
    ]
    if mailbox_dir:
        env_parts.append(f"ECOMDEVAGENT_MAILBOX_DIR={mailbox_dir}")

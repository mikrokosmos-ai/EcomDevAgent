...
from ecomdevagent.teams.backend_detect import BackendDetectionError, detect_backend
from ecomdevagent.teams.mailbox import Mailbox, create_message
...
from ecomdevagent.teams.progress import TeammateProgress
from ecomdevagent.teams.registry import AgentNameRegistry
from ecomdevagent.teams.shared_task import SharedTaskStore
from ecomdevagent.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from ecomdevagent.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)

...
from ecomdevagent.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from ecomdevagent.tools.bash import Bash
    from ecomdevagent.tools.edit_file import EditFile
    from ecomdevagent.tools.file_state_cache import FileStateCache
    from ecomdevagent.tools.glob import Glob
    from ecomdevagent.tools.grep import Grep
    from ecomdevagent.tools.read_file import ReadFile
    from ecomdevagent.tools.write_file import WriteFile

...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from ecomdevagent.agents.fork import ForkError, build_forked_messages
        from ecomdevagent.agents.parser import AgentDef
        from ecomdevagent.agents.tool_filter import resolve_agent_tools
        from ecomdevagent.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from ecomdevagent.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from ecomdevagent.agents.fork import ForkError, build_forked_messages
        from ecomdevagent.agents.parser import AgentDef
        from ecomdevagent.agents.tool_filter import build_teammate_tools
        from ecomdevagent.agent import Agent as AgentClass
        from ecomdevagent.conversation import ConversationManager
        from ecomdevagent.permissions import (
            DangerousCommandDetector,
        ...
        from ecomdevagent.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from ecomdevagent.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from ecomdevagent.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from ecomdevagent.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from ecomdevagent.client import create_client
        from ecomdevagent.config import ProviderConfig

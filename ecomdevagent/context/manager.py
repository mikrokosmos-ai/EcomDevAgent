...
from ecomdevagent.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from ecomdevagent.serialization import build_messages
...
SESSION_SUBDIR = ".ecomdevagent/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from ecomdevagent.tools.base import StreamEnd, StreamEvent, TextDelta

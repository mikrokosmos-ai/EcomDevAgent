...
.ecomdevagent/workflows/journals/{workflow_name}/{run_id}.jsonl
...
from ecomdevagent.workflow.models import AgentCallRecord, JournalEntry

# 单个 journal 文件的大小上限（10 MB）
MAX_JOURNAL_BYTES = 10 * 1024 * 1024

# journal 根目录（相对于项目根目录）
JOURNALS_DIR = ".ecomdevagent/workflows/journals"
        ...
        with open(self._path, encoding="utf-8") as f:
            for line_no, line in enumerate(f, 1):
                ...
                try:
                    ...
                    # 跳过损坏行，记录警告
                    import logging
                    logging.getLogger("ecomdevagent.workflow").warning(

...
from ecomdevagent.skills.parser import SkillDef, substitute_arguments
from ecomdevagent.tools import ToolRegistry

if TYPE_CHECKING:
    from ecomdevagent.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from ecomdevagent.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent

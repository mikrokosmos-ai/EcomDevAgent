...
from ecomdevagent.skills.parser import SkillDef, SkillParseError, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".ecomdevagent/skills"
USER_SKILLS_DIR = "~/.ecomdevagent/skills"
...
class SkillLoader:
    ...
    def _load_builtins(self) -> list[SkillDef]:
        results: list[SkillDef] = []
        builtins_pkg = importlib.resources.files("ecomdevagent.skills.builtins")
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from ecomdevagent.skills.parser import _validate_meta
